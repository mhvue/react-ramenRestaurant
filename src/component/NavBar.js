        ...
        <div>
            <nav className="navbar navbar-light bg-dark">
                <form className="form-inline">
                    ...
                    <button className="btn btn-outline-success contactBtn" id="contactBtn" type="button"><Link to="Contact">Contact</Link></button>
                {homePage ? (
                    <button className="btn btn-outline-success orderNav" type="button" onClick={()=>setPage(false)}><Link to= "Order">Order</Link></button>
                ):(
                    <button className="btn btn-outline-success orderNav" type="button" onClick={()=>setPage(false)}><Link to="orderModal">View Cart</Link></button>
                )}
                </form>
            </nav>
